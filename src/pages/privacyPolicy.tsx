        ...
        <div id="featured-media" className="featured-media has-overlay">
          <div className="wrapper">
            <div className="page-title">
              <h1 className="display">Términos y condiciones</h1>
            </div>
          </div>
        ...
        <div className="wrapper">
          <div className="entry-content">
            ...
            <p>
              ...
              o los servicios que nos ha solicitado, mejorar nuestro servicio y
              las experiencias que usted y los usuarios del sitio web, esperan
              de nosotros.
            </p>
            <h3>Uso de información personal</h3>
            <p>
              Recopilamos información personal que usted comparte con nosotros
              cuando se registra, se comunica o interactúa con nosotros a través
              de nuestro sitio web, por correo electrónico, teléfono u otro
              medio. Puede decidir no proporcionarnos cierta información o
              actualizar, rectificar, suprimir cualquier información que haya
              compartido previamente. Por medio de estas interacciones, usted
              puede compartir con nosotros su nombre, teléfono, correo
              electrónico y tema de proyecto.
            </p>
            <h3>Información compartida</h3>
            <p>
              La información personal que comparte con nosotros, será tratada
              con las siguientes finalidades de carácter general:
            </p>
            <li>
              Responder a sus consultas y solicitudes. Comunicarnos con usted.
            ...
            <p>
              Mantenemos su información personal únicamente durante el plazo que
              necesitemos hacerlo, para así poder usarla por los motivos
