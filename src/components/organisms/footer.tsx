        ...
        <footer className="site-footer">
          ...
          <div className="widget-area">
            <div className="widget widget_logo">
              <h3><a href="index.html" className="footer-title">Realidad Code-ficada</a></h3>
            </div>
            ...
            <div className="widget widget_text">
              <div className="textwidget">
                <h3 className="widget-title">No te pierdas nuestros episodios. ¡Suscríbete ahora!</h3>
                <form className="mc4wp-form" method="post" action="index.html">
                  <div className="mc4wp-form-fields">
                    ...
                    <p className="one-line">
                      <label  className="sr-only">Subscription Email</label> <input type="email" name="email" id="subscribe_email" placeholder="Tu correo electrónico..." required /><input type="submit" value="Suscripción" className="button-color button-filled"/>
                      </p>
                      </div>
                    </form>
                  </div>
            ...
            <div className="copyright">
              <p>&copy; 2023 <a href="index.html">Realidad Code-ficada</a> &mdash; Creado con &hearts; en Colombia. Todos los derechos reservados. &mdash; <a className="privacy-policy-link" href="#">Política de privacidad</a></p>
            </div>
        </footer>   
    )
}
