    ...
    return(
        <div className="featured-episode">
                <div className="featured-episode-text">
                  <p className="text-uppercase text-weight-medium text-opacity-75">Episodio Nuevo</p>
                  <h1 className="display"><a href="single-episode.html">#1: Presentación del pordcast Realidad Code-ficada</a></h1>
                  <p>En este primer episodio del podcast tenemos un invitado muy especial, donde nos hablará de su experiencia, cómo llegó a ser un exitoso empresario y visión del mundo de la tecnología.</p>
                </div>
